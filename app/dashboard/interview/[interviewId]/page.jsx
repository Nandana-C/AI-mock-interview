        ...
        <div className='my-10 flex justify-center flex-col items-center'>
            ...
            <div className='flex flex-col my-5 gap-5'>
                ...
                <div className='p-5 border rounded-lg border-yellow-300 bg-yellow-100'>
                    ...
                    <h2 className='mt-3 text-yellow-500'>Enable video webcam and microphone to start your AI Generated<br/>Mock Interview. It has 5 questions which you can answer and at<br/>last you will get the report on the basis of your answer.<br/>NOTE: We never record your video and you can disable webcam<br/>access at any time you want.
                    </h2>
                </div>
            </div>
            <div>
